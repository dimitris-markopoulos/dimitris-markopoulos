...
| Project | Summary |
|-----------|------------|
| [`self-instruct-gpt4mini`](https://github.com/dimitris-markopoulos/self-instruct-gpt4mini) | Finetune LLM by bootstraping off its own generated {instruction: answer} data [prompt engineering, etc] |
